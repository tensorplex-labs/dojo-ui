  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center overflow-y-auto overflow-x-hidden text-black outline-none backdrop-blur-sm backdrop-brightness-50 focus:outline-none">
      <div className="relative">
        <div className="border-1 relative top-0 m-2 flex w-[900px] min-w-[300px] border-collapse flex-col border border-neutral-950 bg-card-background shadow-brut-sm outline-none focus:outline-none md:m-0">
