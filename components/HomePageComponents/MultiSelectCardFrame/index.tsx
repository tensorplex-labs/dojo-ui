...
const MultiSelectCardFrame: React.FC<MultiSelectCardFrameProps> = ({ mouseX, mouseY }) => {
  ...
  return (
    ...
    >
      <div className="mt-2 h-[150px] w-[190px] self-center rounded-[6px] border-2 border-black bg-muted"></div>
      ...
      <div className="grid grid-cols-2 gap-2 p-2">
        <div className="h-[35px] w-[90px] cursor-pointer rounded-[6px] border-2 border-black bg-gray-200 hover:bg-primary/15"></div>
        <div className="h-[35px] w-[90px] cursor-pointer rounded-[6px] border-2 border-black bg-gray-200 hover:bg-primary/15"></div>
        <div className="h-[35px] w-[90px] cursor-pointer rounded-[6px] border-2 border-black bg-gray-200 hover:bg-primary/15"></div>
        <div className="h-[35px] w-[90px] cursor-pointer rounded-[6px] border-2 border-black bg-gray-200 hover:bg-primary/15"></div>
      </div>
