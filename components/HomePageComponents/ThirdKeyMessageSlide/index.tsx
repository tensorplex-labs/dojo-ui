...
const ThirdKeyMessageSlide = () => {
  ...
  return (
    <motion.section className="z-200 sticky left-0 top-0 flex h-screen w-full justify-center overflow-hidden border-t-4 border-solid border-black bg-gray-100">
      ...
      >
        ...
        <motion.div variants={coinAnimVariant} className="relative flex">
          <div className="-z-1 absolute size-[200px] animate-pulseYandScale rounded-full bg-[#00B6A6] bg-opacity-10"></div>
