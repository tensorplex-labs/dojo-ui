...
const buttonVariants = cva(
  'focus-visible:ring-ring inline-flex h-[45px] items-center justify-center whitespace-nowrap border-2 border-black text-sm font-medium ring-offset-background transition-colors hover:cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none',
  {
    variants: {
      variant: {
