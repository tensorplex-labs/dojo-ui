...
const buttonVariants = cva(
  'h-[45px] hover:cursor-pointer inline-flex items-center border-[2px] border-black justify-center whitespace-nowrap text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none',
  {
    variants: {
      variant: {
        default:
        ...
        link: 'border-0 bg-transparent text-primary underline-offset-4 hover:underline hover:text-primary hover:cursor-pointer visited:text-primary',
        disabled:
