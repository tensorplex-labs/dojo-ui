  ...
  return (
    <div className="mx-auto my-4 flex max-w-[1200px] flex-col items-center justify-center">
      <div className='mt-[42px] flex items-center justify-start self-start text-left'>
        ...
        <span className={`${FontSpaceMono.className} rounded-[20px] border border-black bg-[#D0A215] px-2.5 py-[5px] font-bold text-white`}>CODING GENERATION PROMPT</span>
      </div>
      <>
        <p className="mb-4 flex self-start text-center font-semibold opacity-60">Which animation best represent an animated solar system? The slider should speed up the animation.</p>
