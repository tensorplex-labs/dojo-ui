...
export const faqList = [
  ...
  },
  {
    id: '1',
    content: `
      <p>Set Up Your Miner: Visit <a href="https://github.com/tensorplex-labs/dojo-subnet" target="_blank" style="color: #2563eb; text-decoration: underline; hover:color: #1e40af; hover:text-decoration: none;">Dojo GitHub</a> to set up the Dojo Subnet Miner.</p>
      <br>
      <p>Generate and Use Your API Key: After setting up your miner, generate an API key. Then, visit <a href="https://dojo.tensorplex.ai" target="_blank" style="color: #2563eb; text-decoration: underline; hover:color: #1e40af; hover:text-decoration: none;">dojo.tensorplex.ai</a> and enter your API key to start working.</p>
      <br>
      <p>Start Working: Once logged in, you can start completing tasks and earning rewards immediately.</p>
    `,
